...
1. summary.difficultyScore: ОБЯЗАТЕЛЬНО используй систему оценки сложности выше. Оцени маршрут по всем критериям и выбери соответствующую оценку от 1 до 10. Учитывай КОМБИНАЦИЮ всех факторов, а не только один параметр.
2. summary.difficultyReasoning: подробное объяснение оценки (2-3 предложения), обязательно укажи, какие конкретные факторы повлияли на оценку (протяженность, местность, погода, информация, техническая сложность и т.д.)
